 ...
 * @author Shai Almog
 */
public class ReadyPetGoStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "ReadyPetGo";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new ReadyPetGoStub());
    }
